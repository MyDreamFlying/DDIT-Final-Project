...
<!-- 	          </div> -->
		            ...
		            function initMap() {     
		            	...
		            	malls.forEach(({ label, name, lat, lng }) => {
		            	    ...
		            	    marker.addListener("click", () => {
		            	    	...
		            	    	$.ajax({
		            	    		url : "https://cors-anywhere.herokuapp.com/"+"https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&mode=transit&origins=37.5115557,127.0595261&destinations=37.5251644,126.9255491&region=KR&key=AIzaSyC5-71niDbqZ_IVG8fMxHIHA2bv5cl8w10",
	// 	            				data : {"origins" : "37.541,126.986", "destinations" : "35.1595454,126.8526012", "key" : "AIzaSyC5-71niDbqZ_IVG8fMxHIHA2bv5cl8w10"},
	...
	// 	            					console.log(JSON.stringify(resp.rows[0].elements[0].distance.text));
	            ...
	            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC5-71niDbqZ_IVG8fMxHIHA2bv5cl8w10&callback=initMap" ></script>
