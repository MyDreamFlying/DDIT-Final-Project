...
window.onload=function(){
	apiURI = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=eca3c67ce7c4c0d7ed12983d1e283f7e";
	apiURI2 = "https://api.openweathermap.org/data/2.5/forecast?q="+city+"&appid=eca3c67ce7c4c0d7ed12983d1e283f7e";
  	$.ajax({
   		url: apiURI,
      	dataType: "json",
      	type: "GET",
...
//    	  body: "grant_type=client_credentials&client_id=3RomiS9TWvu8eGG9Dmtn9ztY66qVA4G1&client_secret=zuhVHc8Ns8DF0hMy",
//    	  headers: {
